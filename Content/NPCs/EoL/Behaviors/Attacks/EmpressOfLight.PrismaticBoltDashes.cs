...
namespace WoTE.Content.NPCs.EoL
{
    public partial class EmpressOfLight : ModNPC
    {
        ...
        /// </summary>
        public float PrismaticBoltDashes_DashSpeed => ByPhase(60f, 67f);
        ...
        public void DoBehavior_PrismaticBoltDashes_PerformRedirect()
        {
            ...
            if (NPC.WithinRange(hoverDestination, 35f) && AITimer < PrismaticBoltDashes_HoverRedirectTime && AITimer >= PrismaticBoltDashes_HoverRedirectTime / 2 + 11)
            {
                SoundEngine.PlaySound(SoundID.Item160 with { MaxInstances = 0 }, NPC.Center);
        ...
        public void DoBehavior_PrismaticBoltDashes_PerformPostDashBehaviors()
        {
            ...
            {
                Vector2 boltVelocity = (MathHelper.TwoPi * AITimer / PrismaticBoltSpin_SpinTime * PrismaticBoltDashes_DashDirection * 3f + PrismaticBoltDashes_BoltSpinOffsetAngle).ToRotationVector2() * 0.9f;

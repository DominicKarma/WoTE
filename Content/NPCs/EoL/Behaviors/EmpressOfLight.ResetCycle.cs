    ...
    public partial class EmpressOfLight : ModNPC
    {
        ...
        public void LoadStateTransitions_ResetCycle()
        {
            StateMachine.RegisterTransition(EmpressAIType.ResetCycle, null, false, () => true, () =>
            {
                ...
                List<EmpressAIType> phaseCycle = [EmpressAIType.SequentialDashes, EmpressAIType.BasicPrismaticBolts, EmpressAIType.ButterflyBurstDashes, EmpressAIType.ConvergingTerraprismas, EmpressAIType.OutwardRainbows];
                phaseCycle = [EmpressAIType.ConvergingTerraprismas];
